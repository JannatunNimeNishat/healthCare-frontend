...
const Footer = () => {
  return (
    <Box bgcolor={"rgb(17, 26, 34)"} py={5}>
      <Container color={"#fff"}>
        <Stack  color={"#fff"}  direction={"row"} gap={4} justifyContent={"center"}>
        ...
        <Stack  color={"#fff"}  direction={"row"} gap={2} py={3} justifyContent={"center"}>
          <Image
          src={facebookIcon}
          width={30}
          height={30}
        ...
        <Stack    direction={"row"} justifyContent={"space-between"} alignContent={"center"}  gap={2} py={3}>
